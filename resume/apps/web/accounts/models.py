...
from resume.common.global_choices import USER_LEVEL, USER_TYPE
from resume.core.model_mixins import AddressFields, AuditFields
from resume.core.utils import randcode_gen
